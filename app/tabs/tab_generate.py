...
class TabGenerateFrame(ttk.Frame):
    def __init__(self, parent):
        ...
        self.genbutton.grid(column=0, row=2, sticky="nsew", padx=15, pady=5)
        self.generationout_label.grid(column=0, row=3, sticky="new", padx=15, pady=5)
        self.generation_textbox.grid(column=0, row=3, sticky="snew", padx=15, pady=25)
